...
window.api = {
    ...
    banks: {
        ...
        exportUrl: (id, format = 'json', scope = '') => `/api/banks/${id}/export${toQueryString({ format, scope })}`,
        downloadExport: (id, format = 'json', filenameHint = '', scope = '') => downloadWithAuth(`/banks/${id}/export${toQueryString({ format, scope })}`, filenameHint),
    ...
    questions: {
        ...
        toggleBookmark: (questionId) => apiRequest('/bookmarks/toggle', 'POST', { questionId }),
