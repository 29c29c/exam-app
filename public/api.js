...
window.api = {
    ...
    banks: {
        ...
        exportUrl: (id, format = 'json') => `/api/banks/${id}/export${toQueryString({ format })}`,
        downloadExport: (id, format = 'json', filenameHint = '') => downloadWithAuth(`/banks/${id}/export${toQueryString({ format })}`, filenameHint),
